...
// The blog MVP does not register a Service Worker for the lab. Re-enable only
// after the offline scope is isolated to /lab/ and independently verified.
const PWA_ENABLED = import.meta.env.VITE_ENABLE_LAB_PWA === "true";
